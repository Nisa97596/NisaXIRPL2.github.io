        ...
        <ul class="navbar-nav ms-auto ms-md-0 me-3 me-lg-4">
            <li class="nav-item dropdown">
                <a class="nav-link dropdown-toggle" id="navbarDropdown" href="#" role="button" data-bs-toggle="dropdown"
                    aria-expanded="false"><img class="img_akun" src="e1.jpeg" width="40px" height="40">&nbsp;Earth&nbsp;</a>
                ...
                <div class="Tabel_menu">
                    ...
                    while ($tampil = mysqli_fetch_array($data)) {
                        ...
                        <tr class="head">
                            ...
                            <td>
                                <a
                                    href="hapus-transaksi.php?id=<?php echo $tampil['id_transaksi']; ?>"><button class="hapus">Hapus</button></a>
                                <a
                                    href="edit-transaksi.php?id=<?php echo $tampil['id_transaksi']; ?>"><button class="edit">Edit</button></a>
                            </td>
                        </tr>
