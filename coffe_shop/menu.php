                ...
                <div class="Tabel_menu">
                    ...
                    while ($tampil = mysqli_fetch_array($data)) {
                        ...
                        <tr class="head">
                            ...
                            <td>
                                <a href="hapus-menu.php?id=<?php echo $tampil['id_menu']; ?>"><button class="hapus">Hapus</button></a>
                                <a href="edit-menu.php?id=<?php echo $tampil['id_menu']; ?>"><button class="edit">Edit</button></a>
                            </td>
                        </tr>
