                ...
                <div class="Tabel_menu">
                    ...
                    while ($tampil = mysqli_fetch_array($data)) {
                        ...
                        <tr class="head">
                            ...
                            <td>
                                <a href="hapus-user.php?id=<?php echo $tampil['id_user']; ?>"><button class="hapus">Hapus</button></a>
                                <a href="edit-user.php?id=<?php echo $tampil['id_user']; ?>"><button class="edit">Edit</button></a>
                            </td>
                        </tr>
